...
//     try {
//       const [depositsResponse, merchantAccountsResponse] = await Promise.all([
//         axios.get('/deposits'),
...
//                             className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${
//                               formData.merchantAccountId === account._id
//                                 ? 'border-primary-500 bg-primary-50'
//                                 : 'border-gray-200 hover:border-gray-300'
//                             }`}
//                           >
...
//         {/* ...existing deposit form modal code... */}
//         {/* ...existing image preview modal code... */}
//         {/* Deposits List */}
//         <div className="bg-white border border-gray-200 shadow-sm rounded-xl">
//           <div className="p-6 border-b border-gray-200">
//             <h2 className="text-xl font-semibold text-gray-900">Deposit History</h2>
...
//             <div className="divide-y divide-gray-200">
//               {deposits.map((deposit) => (
//                 <div key={deposit._id || deposit.id} className="p-6">
//                   <div className="flex items-center justify-between">
//                     <div className="flex items-center space-x-4">
//                       {getStatusIcon(deposit.status)}
//                       <div>
...
//               <DollarSign className="w-16 h-16 mx-auto mb-4 text-gray-300" />
//               <h3 className="mb-2 text-lg font-semibold text-gray-900">No deposits yet</h3>
//               <p className="mb-6 text-gray-600">Start your investment journey by making your first deposit</p>
//               <button
//                 onClick={() => setShowDepositForm(true)}
//                 className="px-6 py-3 font-medium text-white rounded-lg bg-primary-600 hover:bg-primary-700"
//               >
...
//                                 </p>
//                                 <p className="text-gray-600">
//                                   Monthly Return: {pkg.monthlyReturn ? pkg.monthlyReturn.toLocaleString() : (pkg.dailyReturn ? pkg.dailyReturn.toLocaleString() : '')} ETB
//                                 </p>
//                               </div>
//                             </div>
//                           );
...
//                       </div>
//                     </div>
//                     {/* ...existing code for upgrade form... */}
//                   </div>
//                 )}
//               </div>
//             </div>
...
//     <div className="divide-y divide-gray-200">
//       {deposits.map((deposit) => (
//         <div key={deposit._id || deposit._id} className="p-6">
...
//                 onClick={() => handleUpgradePackageSelect(pkg)}
//                 className={`p - 4 border - 2 rounded - lg cursor - pointer transition - all ${
//   upgradeFormData.newPackage === pkg.name
//   ? 'border-primary-500 bg-primary-50'
//   : 'border-gray-200 hover:border-gray-300'
// } `}
//               >
...
// <<<<<<< HEAD
//             className={`p - 3 border - 2 rounded - lg cursor - pointer transition - all ${
//   upgradeFormData.paymentMethod === 'bank_transfer'
//   ? 'border-primary-500 bg-primary-50'
//   : 'border-gray-200 hover:border-gray-300'
// } `}
// =======
...
//     : 'border-gray-200 hover:border-gray-300'
// } `}
// >>>>>>> 61cf020ad145fb307d5c9208c2aa45d35498eb24
//           >
//             <div className="flex items-center space-x-2">
//               <CreditCard className="w-5 h-5 text-primary-600" />
//               <span className="font-medium">Bank Transfer</span>
...
// <<<<<<< HEAD
//             className={`p - 3 border - 2 rounded - lg cursor - pointer transition - all ${
//   upgradeFormData.paymentMethod === 'mobile_money'
//   ? 'border-primary-500 bg-primary-50'
//   : 'border-gray-200 hover:border-gray-300'
// } `}
// =======
...
//               onClick={() => setUpgradeFormData(prev => ({ ...prev, merchantAccountId: account._id }))}
//               className={`p - 4 border - 2 rounded - lg cursor - pointer transition - all ${
//   upgradeFormData.merchantAccountId === account._id
//   ? 'border-primary-500 bg-primary-50'
//   : 'border-gray-200 hover:border-gray-300'
// } `}
//             >
...
//                     <span className="text-sm text-gray-600">Bank:</span>
//                     <span className="text-sm">{account.bankName}</span>
//                     {/* Optionally show phone number if present */}
//                     {account.phoneNumber && (
